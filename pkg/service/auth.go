...
const (
	salt       = "aslmdjaklsrfpoqwejfklqsjflkjqsadif901349134r91uwjodj"
	tokenTTL   = 12 * time.Hour
	singninKey = "dfqeerqeqdas112eqsd123qad"
)
...
func (s *AuthService) GenerateToken(username, password string) (string, error) {
	...
	return token.SignedString([]byte(singninKey))
}
